      ...
      (f = {
        ...
        touch: function () {
          ...
          var s,
            ...
            w = 0;
          r
            ? ((t.style.msTouchAction = 'none'), (t._gesture = new MSGesture()), (t._gesture.target = t), t.addEventListener('MSPointerDown', e, !1), (t._slider = n), t.addEventListener('MSGestureChange', a, !1), t.addEventListener('MSGestureEnd', i, !1))
            : ((g = function (e) {
